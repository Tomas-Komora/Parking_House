...
public class Project2 {
    ...
    public static final Class<? extends Application> APPLICATION_CLASS = ApplicationClass.class; // TODO sem dosaď vlastnú triedu
    ...
    public static void postStart() {
        ...
        if(service.getUser("admin@vsa.sk") == null) {
            User admin = (User) service.createUser("admin", "admin", "admin@vsa.sk");
        }
    }
